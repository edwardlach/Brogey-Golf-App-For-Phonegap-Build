...
if( $_GET['previousround'] ){
	...
	$league_weeks_query = mysqli_query( $link, "SELECT weeks FROM bg_app_league WHERE league_id = '$league_id'" );
	$league_weeks_row = mysqli_fetch_row( $league_weeks_query );
	$league_weeks = $league_weeks_row[0];
	...
	$round_number = $league_weeks / $league_frequency;
...
<div data-role="page" id="display_most_recent_round">
	...
	<div data-role="content" class="most_recent_round_content">
		...
		<div class="round_result_title">
			...
			</br>Round <?php echo $round_number; ?> Results
		</div>
		...
		<div class="swipe_instructions">Swipe<span class="swipe_arrow">&emsp;&#x232a;</span> Round List</div> -->
