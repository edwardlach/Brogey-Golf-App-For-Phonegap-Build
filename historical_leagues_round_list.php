...
<div data-role="page" id="display_previous_round">
	...
	<div data-role="content" class="previous_round_content">
		...
		<div class="swipe_instructions">Swipe<span class="swipe_arrow">&emsp;&#x232a;</span> Historical Leagues</div>-->
...
$('.previous_round_list_row').on( 'click', function(){
	...
	$(location).attr( 'href', 'historical_leagues_previous_round.php?previousround='+previousRound );
