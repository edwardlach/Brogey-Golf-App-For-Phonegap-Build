...
<div data-role="page" id="email_invite">
	...
	<div data-role="header" data-position="fixed">
		<div class="site_title">
			<div>
				<div id="site_title">
					<span id="site_title" class="home_page_site_title">
	...
	<form class="faq_register_button" method="post">
		<a id="invite_brogey_button" href="<?php echo $url_link; ?>">Register For Brogey Golf</a>
	</form>
	
	<div data-role="content" class="faq_content">
	
		<div class="leaderboard_accordion">
		    <div class="leaderboard_section question_1">
